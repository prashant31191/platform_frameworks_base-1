...
public class DokdoDream extends Activity {
    FrameLayout mContent;
    int mCount;
    final Handler mHandler = new Handler();
    static final int BGCOLOR = 0xFFFFFFFF;
    final static int TOAST_COLOR = 0xC0000000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setImageResource(com.android.internal.R.drawable.dokdo_dream);
        ...
        tv.setTextColor(0xC0000000);
        tv.setGravity(Gravity.CENTER);
        tv.setText("2014 Dokdo Project");
